...
class VirtualMachine:
    def __init__(self):
        # If an object has a method to reset or reinitialize itself it would break
        self.initialize([])
        # To look better instead of writing it over and over again
        self.prompt = ">>"

    # Load Program decimals into Ram
...
# [/init]
    ...
    # [fetch]
    # OP_Mask takes 1 byte from behind and then shifts by a byte
    # Data gets loaded and split
    ...
    def run(self):
        ...
        while running:
            ...
            # [/store] - arg1 new location to store, arg0 address what to store
            # [add]
            ...
            # [/beq]
                ...
                # why not
                # print(self.prompt, self.ram[arg0])
